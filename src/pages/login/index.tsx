...
import bgimg from "src/static/img/login/sky.png";
import earth_bg from "src/static/img/login/earth_bg.png";
import cloudimg from "src/static/img/login/cloud.png";
import starflake1 from "src/static/img/login/starflake1.png";
import starflake2 from "src/static/img/login/starflake2.png";
import human from "src/static/img/login/login_human.png";
import "./index.scss";
        ...
        <div className="login-plane-container">
          ...
          <div className="login-plane-title">
            ...
            <img
              ...
              src="src/static/img/login/login_horizontal_line.png"
              alt=""
            />
          </div>
          <div className="login-plane-form">
            <Form>
              ...
              <Form.Item>
                <Checkbox v-model="formField.whetherAutoLogin">
                  自动登陆
                </Checkbox>
              </Form.Item>
            </Form>
